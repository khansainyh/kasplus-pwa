        ...
        <div class="bg-white p-4 rounded-lg shadow-md">
            ...
            <form action="{{ route('produk.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm @error('nama') border-red-500 @enderror" required>
                    @error('nama')
                ...
                <div x-data="{ variasis: {{ json_encode(old('variasis', [['nama' => '', 'harga' => '', 'stok' => '']])) }} }">
                    ...
                    <template x-for="(variasi, index) in variasis" :key="index">
                        <div class="grid grid-cols-12 gap-2 items-center mb-2 p-2 border rounded-md">
                            <div class="col-span-4">
                                <label class="block text-xs font-medium text-gray">Nama Variasi</label>
                            ...
                            <div class="col-span-3">
                                <label class="block text-xs font-medium text-gray">Harga</label>
                            ...
                            <div class="col-span-3">
                                <label class="block text-xs font-medium text-gray">Stok</label>
                    ...
                    <button @click.prevent="variasis.push({ nama: '', harga: '', stok: '' })" class="text-sm text-blue-600 hover:underline">+ Tambah Variasi</button>
                </div>
